...
public class CommandParser {
  ...
  public static void printHelp() {
    ...
    System.out.println(
        "\tList all logs of wanted project, grouped with the starting date of each log.");
    System.out.println("start PROJECT_NAME");
    System.out.println(
        "\tStart one project. If this project is not found, a confirmation is needed.");
  ...
  public static void listProjectLog(String project_name) {
    ...
    for (final Long day : keys) {
      final String full_text_date =
          Instant.ofEpochSecond(day * TimeLogManager.SECONDS_PER_DAY).toString();
